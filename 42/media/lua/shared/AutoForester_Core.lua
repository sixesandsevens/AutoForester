...
-- Tiny action to chain callbacks in the queue
...
-- Watchdog to unstick queues (but DO NOT register here!)
...
-- Register is called from the Boot file after Events exist.
function Core.register()
    if Events and Events.EveryOneSecond and Events.EveryOneSecond.Add then
        ...
        print("[AutoForester][WARN] EveryOneSecond not ready; deferring")
